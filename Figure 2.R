...
callr::r(function() {
  ...
  #combine them
  figures[["D"]] <- ggalign::align_plots(!!!plot_list, nrow = 1)
  ...
  #align both figures
  figures[["E"]] <- ggalign::align_plots(!!!plot_list, guides = "rltb")
  
  top <- ggalign::align_plots(!!!figures[c("A", "B")], widths = c(0.2, 0.8))
  middle <- ggalign::align_plots(!!!figures[c("C", "D")], widths = c(0.15, 0.85))
  final <- ggalign::align_plots(top, NULL, middle, NULL, figures[["E"]], ncol = 1, heights = c(0.33, 0.02, 0.13, 0.02, 0.40))
