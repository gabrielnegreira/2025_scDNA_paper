...
callr::r(function() {
  ...
  #align both figures
  figures[["A"]] <- ggalign::align_plots(!!!plot_list, guides = "r")
  ...
  figures[["B"]] <- ggalign::align_plots(!!!plot_list, guides = "r", )
  ...
  figures[["C"]] <- plot+scale_fill_manual(values = create_colors(plot$data$color, palette = "colorblind friendly"))
  ...
  figures[["D"]] <- ggalign::align_plots(!!!net_plot_list, nrow = 1) + layout_tags(NULL)
  
  final <- ggalign::align_plots(figures[["A"]], NULL, figures[["B"]], NULL, figures[["C"]], ncol = 1, heights = c(0.4, 0.025, 0.4, 0.025, 0.15))
